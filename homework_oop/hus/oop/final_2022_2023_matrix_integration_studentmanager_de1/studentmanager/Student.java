package hus.oop.final_2022_2023_matrix_integration_studentmanager_de1.studentmanager;
...
public class Student {
    ...
    public double getAverageGrade() {
        /* TODO */
        return (this.mathsGrade + this.physicsGrade + this.chemistryGrade) / 3.0;
    }
    @Override
    public String toString() {
        return String.format(
                "Student{id='%s', lastname='%s', firstname='%s', yearOfBirth=%d, maths=%.2f, physics=%.2f, chemistry=%.2f, average=%.2f}",
                id, lastname, firstname, yearOfBirth, mathsGrade, physicsGrade, chemistryGrade, getAverageGrade()
        );
    }
}
